...
public class Constants {
    ...
    public class DefaultDemoSpeeds {
        public static final double RSL = 0.75;

        public static final double DRIVETRAIN = 0.5;
        // public static final double SPINDEXER = 0.5;
        public static final double COLLECTOR = 0.75;
